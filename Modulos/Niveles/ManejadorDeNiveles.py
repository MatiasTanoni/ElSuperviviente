...
class ManejadorDeNiveles:
    def __init__(self) -> None:
        """
        Brief: Constructor de la clase ManejadorDeNiveles.
            Inicializa un objeto ManejadorDeNiveles con un diccionario que asocia nombres de niveles con las clases
