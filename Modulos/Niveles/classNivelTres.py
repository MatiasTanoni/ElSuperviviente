from Modulos.Caracteres.ClassJefeFinal import Jefe
from Modulos.Caracteres.classItem import Item
from Modulos.Caracteres.classCaenObjetos import CaenObjetos
from Modulos.Caracteres.classPersonaje import Personaje
from Modulos.Caracteres.classEnemigo import Enemigo
from Modulos.Caracteres.classPlataformas import Plataforma
from Modulos.Caracteres.classTrampas import Trampas
from Modulos.Niveles.nivel import Nivel

class NivelTres(Nivel):
    def __init__(self,tamano):
        super().__init__(tamano)
        self.establecer_imagen_fondo("Modulos\Assets\Imagenes\\background.png")
        ...
        self.establecer_musica("Modulos\Assets\Musica\game.mp3")
    ...
    def actualizar(self,evento):
        ...
        self.mostrar_tiempo()
        self.completado = self.personaje.nivel_completado
