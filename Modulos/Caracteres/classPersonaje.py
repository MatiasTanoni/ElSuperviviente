import pygame as py
from Modulos.Caracteres.classDisparo import Disparo
...
class Personaje(Object):
    ...
    def verificar_evento(self):
        ...
        if self.flag_disparo and teclas[py.K_f]:
            ...
            if tiempo_actual - self.tiempo_ultimo_disparo >= 1000:
                ...
                self.efectos_de_sonido(r"Modulos\Assets\Musica\sonido de disparo.mp3",0.2)
                self.flag_disparo = False
    ...
    def cargar_animaciones(self):
        ...
        lista_rutas = [r"Modulos\Assets\Imagenes\DERECHa.png",r"Modulos\Assets\Imagenes\DERECha_2.png",r"Modulos\Assets\Imagenes\DERECHA 3.png",r"Modulos\Assets\Imagenes\DERECHA 4.png",r"Modulos\Assets\Imagenes\DERECHA 5.png",r"Modulos\Assets\Imagenes\DERECHA 6.png"]
        lista_rutas_2 = [r"Modulos\Assets\Imagenes\saltandoo.png",r"Modulos\Assets\Imagenes\saltando_2.png"]
        lista_rutas_3 = [r"Modulos\Assets\Imagenes\quieto1.png",r"Modulos\Assets\Imagenes\quieto1.png",r"Modulos\Assets\Imagenes\quieto2.png",r"Modulos\Assets\Imagenes\quieto2.png",r"Modulos\Assets\Imagenes\quieto3.png",r"Modulos\Assets\Imagenes\quieto3.png",r"Modulos\Assets\Imagenes\quieto4.png",r"Modulos\Assets\Imagenes\quieto4.png",r"Modulos\Assets\Imagenes\quieto5.png",r"Modulos\Assets\Imagenes\quieto5.png",r"Modulos\Assets\Imagenes\quieto6.png",r"Modulos\Assets\Imagenes\quieto6.png",r"Modulos\Assets\Imagenes\quieto7.png",r"Modulos\Assets\Imagenes\quieto7.png"]
    ...
    def mostrar_vida(self,pantalla):
        ...
        """
        vida1 = self.cargar_imagen(r"Modulos\Assets\Imagenes\full vida.png",(160,40))
        vida2 = self.cargar_imagen(r"Modulos\Assets\Imagenes\vida 3,4.png",(160,40))
        vida3 = self.cargar_imagen(r"Modulos\Assets\Imagenes\vida 2,4.png",(160,40))
        vida4 = self.cargar_imagen(r"Modulos\Assets\Imagenes\0_de_vida.png",(160,40))
        if self.vidas == 3:
